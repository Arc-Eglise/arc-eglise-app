      ...
      <div className="hidden lg:block" style={{ position: "relative", height: 560 }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 16, marginTop: 14, paddingTop: 14, borderTop: "1px solid rgba(30,36,100,.12)" }}>
            <div><div style={{ fontWeight: 700, color: "#1e2464", fontSize: 15 }}>1.4k</div><div style={{ fontSize: 11, color: "#6b6f86" }}>Vues</div></div>
            <div><div style={{ fontWeight: 700, color: "#1e2464", fontSize: 15 }}>32</div><div style={{ fontSize: 11, color: "#6b6f86" }}>Nations</div></div>
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            ...
            <span style={{ background: "#C9A227", color: "#141738", fontWeight: 700, fontSize: 12, padding: "3px 9px", borderRadius: 999 }}>CHF 25</span>
          </div>
          <div className="font-serif" style={{ fontSize: 23, fontWeight: 600, lineHeight: 1.1 }}>Soirée Gospel & Dîner</div>
          <div style={{ fontSize: 12.5, color: "rgba(255,255,255,.7)", marginTop: 7 }}>Sam 27 juin · 18h00 · 22/60 places</div>
          <button
